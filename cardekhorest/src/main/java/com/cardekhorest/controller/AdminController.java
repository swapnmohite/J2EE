...
import com.cardekhorest.response.AdminResponse;
import com.cardekhorest.service.AdminService;
...
public class AdminController {
	...
	public ResponseEntity<AdminResponse> createAccount(@RequestBody AdminPOJO pojo) {
		...
		// SUCCESS
		if (admin != null) {
			return new ResponseEntity<AdminResponse>(new AdminResponse("Account created succesfully. ", admin),
					HttpStatus.ACCEPTED);
		}
